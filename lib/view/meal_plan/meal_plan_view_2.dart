...
class _MealPlanView2State extends State<MealPlanView2> {
  ...
  List workArr = [
    ...
    {"name": "Breakfast", "title": "vegetable, Sandwich", "image": "assets/img/f3.png",},
    {"name": "Snack", "title": "Boat, nut, butter", "image": "assets/img/f4.png",},
  ];
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(color: TColor.background),
                  child: Column(
