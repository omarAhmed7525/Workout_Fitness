  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        Container(
          decoration: BoxDecoration(color: TColor.surface, boxShadow: const [
            BoxShadow(
        ...
        Expanded(
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  decoration: BoxDecoration(color: TColor.surface),
                  child: Column(
                    children: [
                      Stack(
                            ...
                            IconButton(
                                onPressed: () {
                                 ...
                                 icon: Image.asset("assets/img/more.png",
                                    width: 25, height: 25, color: TColor.secondaryText))
                          ],
                        ),
                      ),
                    ],
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () {},
                child:
                    Image.asset("assets/img/more.png", width: 25, height: 25, color: TColor.secondaryText),
              ),
            ],
          ),
        ),
